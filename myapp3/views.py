...
from django.shortcuts import render, get_object_or_404  # если не получили из бд, то страница не найдена
from django.views.generic import TemplateView  # создание представление на основе классов
...
class TemplIf(TemplateView):
    template_name = "myapp3/templ_if.html"  # template_name зарезервированное имя, его Django и будет искать
...
def author_posts(request, author_id):
    ...
    posts = Post.objects.filter(author=author).order_by('-id')[:5]  # в обратном порядке пять старых записей
